...
### Extended function for reading in data to database
...
dbAppendUniqueDataToStaffdose_Ext <- function(path_data="reports", file_name_beginning="StaffDose") {
  # function to add unique data to a table of a database
