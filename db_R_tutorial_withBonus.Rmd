...
all_reports_fixed <- all_reports %>% 
  ...
  # "B": Below Measurement Threshold, "NR": Not returned, "NA": missing value; "OK" where a numeric value exists for the variables hp10 and hp007)
...
```{r, eval=FALSE}
# This code chunk is not executed automatically when the Rmd is rendered to html because
...
# 612 new dosimeter readings should have been read in
# if the table was empty before running this function 612 lines should have been added
  # and should be found in the table after the execution
...
dbAppendUniqueDataToStaffdose_Ext()
# 612 dosimeter readings are read in but 0 are added to the database because
